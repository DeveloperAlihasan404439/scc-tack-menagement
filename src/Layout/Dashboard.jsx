  ...
  return (
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-content flex flex-col">
        <label
          htmlFor="my-drawer-2"
          className="drawer-button lg:hidden text-end "
        >
      ...
      <div className="drawer-side">
        ...
        <ul className="menu p-4 w-80 min-h-full bg-gradient-to-r from-[#07163d] to-[#3D8AD0] text-white">
          {/* Sidebar content here */}
            ...
            <Link className="hover:bg-white hover:text-black text-lg rounded mb-1 font-normal px-4 py-1">Previous Tasks</Link>
